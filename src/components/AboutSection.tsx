...
const AboutSection = () => (
  <section className="py-24 px-6 bg-beige">
    <div className="max-w-4xl mx-auto">
      ...
      >
        The best ideas don't avoid hard conversations — they redesign them.
        Join us for a full-day hackathon on ethics, civil discourse, and the art of
        teaching difficult things. No game design, learning design, or teaching experience required.
      </motion.p>
